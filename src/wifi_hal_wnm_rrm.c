...
#if !defined(PLATFORM_LINUX) && !defined(_COSA_QCA_ARM_) || defined(_PLATFORM_BANANAPI_R4_) || defined(_PLATFORM_RASPBERRYPI_)
...
#endif /* !defined(PLATFORM_LINUX) && !defined(_COSA_QCA_ARM_) || ... */
